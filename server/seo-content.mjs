...
const KEYWORDS_BASE =
	"beatgrid, rhythm game, vocal game, beat challenge, nano banana";
...
const SEO_CONTENT = {
	...
	ru: {
		...
		description:
			"Вирусная ритм-игра от Nano Banana. Используй свой голос, держи темп и делись своим флоу.",
	...
	ar: {
		...
		description:
			"لعبة الإيقاع الفيروسية بدعم من Nano Banana. استخدم صوتك، حافظ على الإيقاع وشارك إبداعك.",
	...
	ko: {
		...
		description:
			"Nano Banana가 제공하는 바이럴 리듬 게임. 목소리를 사용하여 템포를 맞추고 플로우를 공유하세요.",
		h1: "비트에 맞춰 말해봐",
	...
	"zh-Hans": {
		...
		description:
			"由 Nano Banana 驱动的病毒式节奏游戏。使用你的声音，保持节奏，分享你的Flow。",
		h1: "跟着节拍说单词",
	...
	tr: {
		...
		description:
			"Nano Banana tarafından sunulan viral ritim oyunu. Sesini kullan, tempoyu tut ve akışını paylaş.",
	...
	th: {
		...
		description:
			"เกมจังหวะไวรัลที่ขับเคลื่อนโดย Nano Banana ใช้เสียงของคุณ รักษาจังหวะ และแชร์โฟลว์ของคุณ",
...
export const getSeoData = (lang) => {
	...
	if (base === "zh") {
		...
		if (hasHant && SEO_CONTENT["zh-Hant"]) return SEO_CONTENT["zh-Hant"];
